...
export declare const QUESTIONNAIRE: ({
    ...
    name: string;
    message: string;
    choices: (answers: Questionnair) => readonly ["On my local machine", "In the cloud using Experitest", "In the cloud using Sauce Labs", "In the cloud using Browserstack or Testingbot or LambdaTest or a different service", "I have my own Selenium cloud"] | ("On my local machine" | "In the cloud using Experitest" | "In the cloud using Sauce Labs" | "In the cloud using Browserstack or Testingbot or LambdaTest or a different service" | "I have my own Selenium cloud")[];
    when?: undefined;
    default?: undefined;
    validate?: undefined;
} | {
